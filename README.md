This repository was created as an exercise to learn about compilers and is a project is a BIG work in progress. Right now only simple math expressions can be compiled and executed. 
